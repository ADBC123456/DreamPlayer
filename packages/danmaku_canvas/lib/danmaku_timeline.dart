class CanvasDanmakuTimeline {
  ...
  static bool didSeek({
    ...
    return (currentTime - previousTime).abs() > fallbackSeekThresholdSeconds;
  }
  ...
  static double scrollProgress({
    ...
    return ((currentTime - scheduledTime) / durationSeconds).clamp(0.0, 1.0);
  }
  ...
  static double advanceScrollX({
    ...
    return currentX - wallSeconds * playbackRate * distance / durationSeconds;
  }
...
class ScrollDanmakuCollision {
  static bool canPlace({
    ...
    final candidateSpeed = (viewWidth + candidateWidth) / durationSeconds;
