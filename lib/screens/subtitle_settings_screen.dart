...
class _SubtitleSettingsScreenState extends State<SubtitleSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const AppText('Subtitles')),
      body: !_loaded
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: LayoutBuilder(
                      builder: (context, _) {
                        ...
                        final maxH = media.height * (isLandscape ? 0.42 : 0.35);
                  ...
                  Padding(
                    ...
                    child: SegmentedButton<double>(
                      ...
                      onSelectionChanged: (selection) => _update(
                        _style.copyWith(sizeMultiplier: selection.first),
                      ),
                    ),
                  ),
                    ...
                    child: Wrap(
                      ...
                      children: _colorOptions.entries.map((entry) {
                        ...
                        return InkWell(
                          ...
                          onTap: () =>
                              _update(_style.copyWith(colorValue: entry.key)),
                          child: Container(
                    ...
                    child: SegmentedButton<int>(
                      segments: _bgOptions.entries
                          .map(
                            (e) => ButtonSegment(
                              value: e.key,
                              label: AppText(e.value),
                            ),
                          )
                          .toList(),
                      selected: {
                        _bgOptions.keys.contains(_style.backgroundColorValue)
                            ? _style.backgroundColorValue
                            : 0x00000000,
                      },
                      onSelectionChanged: (selection) => _update(
                  ...
                  SwitchListTile(
                    ...
                    title: const AppText('Black outline'),
                    subtitle: const AppText(
                      'Shadow behind glyphs for readability',
                    ),
                    value: _style.outline,
                    onChanged: (value) =>
                        _update(_style.copyWith(outline: value)),
                  ),
                        ...
                        children: [
                          Row(
                            children: [
                              Expanded(
                                child: AppText(
                                  '${((_style.backgroundOpacity / 255.0) * 100).round()}%',
                              ...
                              TextButton(
                                onPressed: _style.backgroundOpacity == 128
                                    ? null
                                    : () => _update(
                                        _style.copyWith(backgroundOpacity: 128),
                                      ),
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: _style.verticalPosition == 20
                                  ? null
                                  : () => _update(
                                      _style.copyWith(verticalPosition: 20),
                                    ),
                              style: TextButton.styleFrom(
                                padding: const EdgeInsets.symmetric(
                                  horizontal: 8,
